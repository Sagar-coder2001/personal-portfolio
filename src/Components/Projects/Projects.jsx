...
//         ${bgcolor1 === 'black' ? 'group-hover:text-black' : 'group-hover:text-black'}`}
//           >
//             Get in Touch
//           </span>
//           <span
...
//             key={index}
//             className="relative group border border-gray-300 rounded-xl p-6 text-white 
...
const Projects = () => {
  const projects = [
    {
      title: "Student Learning Management System",
      description: "A web app where instructors can create and manage courses, while students can enroll, view content, and track progress. Built with role-based access for students and instructors.",
      image: Cloud,
      technologies: ["React", "Node.js", "MongoDB", "Tailwind CSS"],
      githubUrl: "https://github.com/Sagar-coder2001/student-LMS",
      live: 'https://student-lms-rho.vercel.app/'
    },
    {
      title: "Chat Application in Mern",
      description: "This is a full-stack real-time chat application built with the MERN stack (MongoDB, Express, React, Node.js) and Socket.IO for bi-directional, low-latency communication. The app enables users to register, log in, and engage in instant messaging with others in a secure and responsive environment.",
      image: chat,
      technologies: ["React", "Socket.io", "MongoDB", "Tailwind" , "Node.js"],
      githubUrl: "https://github.com/Sagar-coder2001/Mern-Chat-App",
      live: 'https://mern-chat-app-xi-ochre.vercel.app/'
    },

    {
      title: "Book Store UI",
      description: "This project is a visually appealing, static book store interface built using React and Tailwind CSS. The focus is on delivering a clean, responsive design with interactive elements to enhance user engagement.",
      image: library,
      technologies: ["React", "Tailwind CSS", "JavaScript", "HTML"],
      githubUrl: "https://github.com/Sagar-coder2001/Book_Store",
      live: 'https://book-store-six-plum.vercel.app/'
    },

    {
      title: "Metaverse VR UI",
      description: "This project is a futuristic, animated Metaverse user interface crafted using React and Tailwind CSS, focused on delivering a highly visual and interactive design. The interface showcases the potential of VR spaces with smooth animations, modern layouts, and immersive hover effects.",
      image: hero,
      technologies: ["React", "Tailwind CSS", "JavaScript", "HTML"],
      githubUrl: "https://github.com/Sagar-coder2001/World",
      live: 'https://world-two-orpin.vercel.app/'
    },

    {
      title: "Mern E-Commerce Project",
      description: "A full-stack e-commerce app where users can browse, add to cart, and place orders. Admins can manage products and view or update orders through a secure dashboard. Built using MongoDB, Express, React, and Node.js.",
      image: mail,
      technologies: ["React", "Node.js", "MongoDB", "Tailwind CSS", "Stripe"],
      githubUrl: "https://github.com/Sagar-coder2001/sagar---E",
      live: 'https://sagar-e.vercel.app/'
    },
    {
      title: "Hotel Queue Managment System",
      description: "An ongoing project to streamline hotel check-in by managing guest queues digitally, reducing wait times, and improving service efficiency.",
      image: shield,
       technologies: ["React", "CSS", "JavaScript", "HTML"],
      githubUrl: "https://github.com/Sagar-coder2001/HotelAdminDashboard-Queue"
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 rounded-lg overflow-hidden"
            style={{textAlign:'center'}}
            >
              <img src={project.image || "/placeholder.svg"} alt={project.title} className="w-20 h-20 object-cover text-center mx-auto mt-5" />
              <div className="p-6">
                <h3 className="text-white text-xl font-semibold mb-2">{project.title}</h3>
                <p className="text-gray-300 mb-4">{project.description}</p>
                <div className="flex flex-wrap gap-2 mb-4 justify-center">
                  {project.technologies.map((tech, techIndex) => (
                    <span key={techIndex} className="px-2 py-1 bg-blue-500/30 text-blue-300 rounded-full text-sm" >
                      {tech}
                    </span>
                  ))}
                </div>
                <div className="flex gap-4" style={{margin:'10px 5px'}}>
                  <a className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 transition-colors" href={project.live}>
                    <ExternalLink className="h-4 w-4" />
                    Live Demo
                  </a>
                  <a className="border border-white/20 text-white hover:bg-white/10 bg-transparent px-4 py-2 rounded-lg flex items-center justify-center gap-2 transition-colors" href={project.githubUrl}>
